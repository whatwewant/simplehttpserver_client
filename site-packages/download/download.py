...
def download_url(url, absolute_file_name, number=1, log=False):
    if not log:
        download_without_log(url, absolute_file_name, number)
    else:
        download_log(url, absolute_file_name, number, log)
...
def download_log(url, absolute_file_name, number, log):
    '''
        download 
    '''
    # file_name = url.split('/')[-1]
